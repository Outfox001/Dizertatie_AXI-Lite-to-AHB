...
module axi_ahb_bridge_core #(
  ...
  always_comb begin
    if (!aresetn)                                                   bresp = '0;                                        else // Default B response
                                                                    bresp = resp_fifo_rresp;                           // Drive B response
  end
  ...
  always_comb begin
    if (!aresetn)                                                   rdata = '0;                                        else // Default R data
                                                                    rdata = resp_fifo_rrdata;                          // Drive R data
  end
  ...
  always_comb begin
    if (!aresetn)                                                   rresp = '0;                                        else // Default R response
                                                                    rresp = resp_fifo_rresp;                           // Drive R response
  end
